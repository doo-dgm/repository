...
public class PruningToolSqlServerDAO extends SqlConnection implements PruningToolDAO {
    ...
    public void create(final PruningToolEntity entity) {
        ...
        try (var preparedStatement = getConnection().prepareStatement(PruningToolSql.CREATE)) {
            ...
            var userMessage = MessagesEnum.USER_ERROR_PRUNING_TOOL_CREATE.getContent();
            var technicalMessage = MessagesEnum.TECHNICAL_ERROR_PRUNING_TOOL_CREATE.getContent();
            throw TreePruningException.create(exception, userMessage, technicalMessage);
        } catch (final Exception exception) {
            var userMessage = MessagesEnum.USER_ERROR_PRUNING_TOOL_CREATE_UNEXPECTED.getContent();
            var technicalMessage = MessagesEnum.TECHNICAL_ERROR_PRUNING_TOOL_CREATE_UNEXPECTED.getContent();
            throw TreePruningException.create(exception, userMessage, technicalMessage);
        }
    ...
    public List<PruningToolEntity> findByFilter(final PruningToolEntity filterEntity) {
        ...
        try (var preparedStatement = this.getConnection().prepareStatement(sql)) {                        
            ...
            var userMessage = MessagesEnum.USER_ERROR_PRUNING_TOOL_FIND_BY_FILTER.getContent();
            var technicalMessage = MessagesEnum.TECHNICAL_ERROR_PRUNING_TOOL_FIND_BY_FILTER.getContent();
            throw TreePruningException.create(exception, userMessage, technicalMessage);
        } catch (final Exception exception) {
            var userMessage = MessagesEnum.USER_ERROR_PRUNING_TOOL_FIND_BY_FILTER_UNEXPECTED.getContent();
            var technicalMessage = MessagesEnum.TECHNICAL_ERROR_PRUNING_TOOL_FIND_BY_FILTER_UNEXPECTED.getContent();
            throw TreePruningException.create(exception, userMessage, technicalMessage);
        }
    }
    ...
    public void update(final PruningToolEntity entity) {
        ...
        try (var preparedStatement = getConnection().prepareStatement(PruningToolSql.UPDATE)) {
            ...
            var userMessage = MessagesEnum.USER_ERROR_PRUNING_TOOL_UPDATE.getContent();
            var technicalMessage = MessagesEnum.TECHNICAL_ERROR_PRUNING_TOOL_UPDATE.getContent();
            throw TreePruningException.create(exception, userMessage, technicalMessage);
        } catch (final Exception exception) {
            var userMessage = MessagesEnum.USER_ERROR_PRUNING_TOOL_UPDATE_UNEXPECTED.getContent();
            var technicalMessage = MessagesEnum.TECHNICAL_ERROR_PRUNING_TOOL_UPDATE_UNEXPECTED.getContent();
            throw TreePruningException.create(exception, userMessage, technicalMessage);
        }
    ...
    public void delete(final PruningToolEntity entity) {
        ...
        try (var preparedStatement = getConnection().prepareStatement(PruningToolSql.DELETE)) {
            ...
            var userMessage = MessagesEnum.USER_ERROR_PRUNING_TOOL_DELETE.getContent();
            var technicalMessage = MessagesEnum.TECHNICAL_ERROR_PRUNING_TOOL_DELETE.getContent();
            throw TreePruningException.create(exception, userMessage, technicalMessage);
        } catch (final Exception exception) {
            var userMessage = MessagesEnum.USER_ERROR_PRUNING_TOOL_DELETE_UNEXPECTED.getContent();
            var technicalMessage = MessagesEnum.TECHNICAL_ERROR_PRUNING_TOOL_DELETE_UNEXPECTED.getContent();
            throw TreePruningException.create(exception, userMessage, technicalMessage);
        }
